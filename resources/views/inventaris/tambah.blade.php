                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select id="kondisi" name="kondisi" class="form-select @error('kondisi') is-invalid @enderror">
                                        ...
                                        <option value="layak pakai" @if(old('kondisi') == 'layak pakai') selected @endif>Layak Pakai</option>
                                        <option value="tidak layak pakai" @if(old('kondisi') == 'tidak layak pakai') selected @endif>Tidak Layak Pakai</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-3">
